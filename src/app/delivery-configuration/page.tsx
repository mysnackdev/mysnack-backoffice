      ...
      <span className="relative inline-flex items-center">
        ...
        <span
          className={
            ...
            "transition-transform duration-200 peer-checked:translate-x-[20px]"
          }
        />
      </span>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-zinc-600">
            Escolha os dias e horários que sua loja entregará pedidos.
          </p>
        </div>
        ...
        <div className="rounded-xl border bg-zinc-900 text-white p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <div className="text-lg font-semibold">Horários recomendados para sua cozinha</div>
                <p className="mt-1 text-sm text-zinc-200/90 max-w-3xl">
                  Confira nossas recomendações de horários estratégicos, baseadas em dados para
                  seu tipo de cozinha. Você poderá alterar estes dados depois.
                </p>
              </div>
            </div>
            <button
